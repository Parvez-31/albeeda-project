  ...
  return (
    <div className="bg-slate-50 dark:bg-slate-950 min-h-screen">
      <Helmet>
        ...
        <meta
          name="description"
          content="আলবিদা কোম্পানি সম্পর্কে জানুন — আমাদের লক্ষ্য, মূল্যবোধ এবং সম্পূর্ণ হালাল পণ্য তৈরির প্রতিশ্রুতি।"
        />
        <meta property="og:title" content="আমাদের সম্পর্কে | আলবিদা কোম্পানি" />
        <meta
          property="og:description"
          content="আলবিদা কোম্পানির গল্প — উদ্দেশ্য ও বিশ্বাস নিয়ে গড়া একটি হালাল পণ্য প্রতিষ্ঠান।"
        />
      ...
      <section className="mx-auto max-w-4xl px-4 pt-14 pb-8 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-3xl bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 shadow-xl dark:shadow-slate-950/60">
          ...
          <div className="h-2 w-full bg-linear-to-r from-violet-500 via-indigo-500 to-violet-500" />
          ...
          <div className="px-8 pt-10 pb-12 sm:px-14 text-center">
            ...
            <div className="font-bengali text-left text-base sm:text-lg leading-loose text-slate-600 dark:text-slate-400 max-w-2xl mx-auto space-y-4">
              <p>
                কোম্পানির প্রধান নির্বাহী (CEO) লক্ষ্য করেন যে, মুসলিম সমাজে
                যারা হজ পালন করেন, তাদের অনেকেই জমজমের পানি দিয়ে কাফনের কাপড়
                ধুয়ে থাকেন। ইসলামী শরীয়তের দৃষ্টিতে জমজমের পানি অত্যন্ত
                মর্যাদাপূর্ণ ও গুরুত্বপূর্ণ।
              </p>
              <p>
                তিনি আরও উপলব্ধি করেন যে, সবাই হজে যাওয়ার সৌভাগ্য অর্জন করতে
                পারেন না। ফলে যারা হজে যেতে পারেন না, তারা জমজমের পানি দিয়ে
                ধোয়া কাফনের কাপড় ব্যবহার করার সুযোগ থেকেও বঞ্চিত হন।
              </p>
              <p>
                মুসলিম সমাজের বিপুল সংখ্যক মানুষ হজে যেতে না পারায় জমজমের পানি
                দ্বারা ধৌত কাফনের কাপড় সংগ্রহ করতে পারেন না।
              </p>
              <p>
                এই বিষয়টি বিবেচনা করে কোম্পানির প্রধান নির্বাহী এমন একটি উদ্যোগ
                গ্রহণ করেন, যাতে সকল মুসলিম জমজমের পানি দ্বারা ধৌত কাফনের কাপড়
                ব্যবহার করার সুযোগ পান।
              </p>
              <p>
                এই চিন্তা থেকেই আলবীদা কাফন কোম্পানির- যাত্রা শুরু হয়।
                কোম্পানির সকল পণ্য সম্পূর্ণ হালাল প্রক্রিয়ায় প্রস্তুত করা হয়
                (ইনশাআল্লাহ)।
              </p>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 border border-green-100 dark:border-green-900/40 p-8 sm:p-12 shadow-md">
          <div className="flex flex-col sm:flex-row items-start gap-5">
            ...
            <div>
              ...
              <p className="font-bengali text-base sm:text-lg leading-loose text-slate-600 dark:text-slate-400">
                আলবীদা কোম্পানির উদ্দেশ্য হল প্রতিটি পরিবার তার আপন জনের জন্য
                শেষ সময়ে একটি হালাল এবং গুণগতমান সম্পন্ন জমজম পানি ব্যবহৃত
                কাঁফনের সেট তুলে দিতে পারেন (ইঃ আঃ)।
              </p>
            </div>
          </div>
        </div>
